...
QString YandexTranslate::detectLanguage(const QString &source_text)
{
    // Create a request.
...
QStringList YandexTranslate::translate(const QString& source_lang, const QString& target_lang, const QString& text_to_translate)
{
    // Create a request.
